...
os.environ["IR_DATASETS_TMP"] = os.path.join(current_dir, "ir_tmp")
os.environ["IR_DATASETS_HOME"] = os.path.join(current_dir, ".ir_datasets")
os.makedirs(os.environ["IR_DATASETS_TMP"], exist_ok=True)
